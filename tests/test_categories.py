...
class CategoryTestCase(BaseTestCase):
    ...
    def test_category_creation_wrong_token(self):
        """Test that the Api can create a category"""
        # get the token and context
        token_and_context = self.get_token()
        token = token_and_context['token']
    ...
    def test_get_method_on_category_with_lim_parameter(self):
    ...
    def test_get_method_on_category_with_setoff_parameter(self):
    ...
    def test_get_method_on_category_with_limit_and_setoff_parameter(self):
    ...
    def test_get_method_on_category_with_search_parameter(self):
        """Test GET request on category with offset and limit parameter"""
        # get the token and context
        token_and_context = self.get_token()
        token = token_and_context['token']
    ...
    def test_put_verb_category(self):
